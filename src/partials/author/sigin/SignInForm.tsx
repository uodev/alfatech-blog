    ...
    return (
        <Fragment>
            {response && response.message !== "" ? (
                <div
                    className={`${response.isSuccess ? "bg-green-500" : "bg-red-500"
            ...
            >
                <div className="flex flex-col space-y-2 bg-gray-800/40 p-10 mx-auto mt-5 rounded-lg w-1/2">
                    ...
                    <div
                        className={`my-2  rounded-lg  ${loading ? "bg-gray-500" : "bg-accent"}`}
                    >
                        <button disabled={loading} className="uppercase text-sm font-bold tracking-wide text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline">
