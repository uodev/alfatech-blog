  ...
  return (
    <article className=" max-lg:mx-auto ">
      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="relative flex gap-3 uppercase items-center text-accent text-xs hover:cursor-pointer group w-[95px]">
          <p className="tracking-wider font-[600] ">Read More </p>
